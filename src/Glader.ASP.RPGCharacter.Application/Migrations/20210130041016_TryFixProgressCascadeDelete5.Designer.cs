...
namespace Glader.ASP.RPG.Application.Migrations
{
    ...
    [Migration("20210130041016_TryFixProgressCascadeDelete5")]
    partial class TryFixProgressCascadeDelete5
    {
            ...
            modelBuilder.Entity("Glader.ASP.RPG.DBRPGCharacter<Glader.ASP.RPG.TestRaceType, Glader.ASP.RPG.TestClassType>", b =>
                {
                    ...
                    b.Property<int>("DBRPGCharacterProgress<TestRaceType, TestClassType>Id")
                        .HasColumnType("int");

                    b.Property<int?>("DBRPGCharacterProgress<TestRaceType, TestClassType>Id1")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DBRPGCharacterProgress<TestRaceType, TestClassType>Id1")
                        .IsUnique();
            ...
            modelBuilder.Entity("Glader.ASP.RPG.DBRPGCharacter<Glader.ASP.RPG.TestRaceType, Glader.ASP.RPG.TestClassType>", b =>
                {
                    ...
                    b.HasOne("Glader.ASP.RPG.DBRPGCharacterProgress<Glader.ASP.RPG.TestRaceType, Glader.ASP.RPG.TestClassType>", null)
                        .WithOne("Character")
                        .HasForeignKey("Glader.ASP.RPG.DBRPGCharacter<Glader.ASP.RPG.TestRaceType, Glader.ASP.RPG.TestClassType>", "DBRPGCharacterProgress<TestRaceType, TestClassType>Id1")
                        .OnDelete(DeleteBehavior.Cascade);
